...
@section('content')
    ...
    <div class="row tw-h-full" >
				<div class="col-md-6">
					...
					<img src="{{ asset('img/welcome.png')}}" class="tw-mx-auto tw-max-h-[80vh]" alt="Login Image" />

				</div>
        <div class="col-md-4 twh-full">
            <div
                class="tw-p-5 tw-my-auto md:tw-p-6 tw-mb-4 tw-rounded-2xl tw-transition-all tw-duration-200 tw-bg-white   ">
                    ...
                    <form method="POST" action="{{ route('login') }}" id="login-form">
                        ...
                        <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                            <label class="tw-dw-form-control">
                                ...
                                <input
                                    class="tw-border tw-w-full tw-border-[#D1D5DA] tw-outline-none tw-h-12 tw-bg-transparent tw-rounded-lg tw-px-3 tw-font-medium tw-text-black placeholder:tw-text-gray-500 placeholder:tw-font-medium"
                        ...
                        @endif
                        <button type="submit"
						class="tw-bg-gradient-to-r tw-from-green-500 tw-to-green-400 tw-h-12 tw-rounded-xl tw-text-sm md:tw-text-base tw-text-white tw-font-semibold tw-w-full tw-max-w-full tw-mt-2 tw-hover:from-green-600 tw-hover:to-green-500 tw-focus:outline-none tw-focus:ring-2 tw-focus:ring-green-500 tw-focus:ring-offset-2 tw-active:from-green-700 tw-active:to-green-600">
                            @lang('lang_v1.login')
                        </button>
                    </form>
